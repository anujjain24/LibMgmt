...
public class LibrarianLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Libraian login Form");
    ...
    System.out.println("Admin1 Name:"+adname+"Pass:"+adpass);
       ...
       String sql="SELECT * FROM member WHERE Name='"+adname+"' AND Password='"+adpass+"'";
 ...
 adminorlogin al =new adminorlogin();
 al.show();
        // TODO add your handling code here:
